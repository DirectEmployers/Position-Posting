...
let s:cpo_save=&cpo
set cpo&vim
imap <F7> :call Whitespace_on_off()
imap <F6> :call List_on_off()
imap <F5> :call Paste_on_off()
...
map <F7> :call Whitespace_on_off()
map <F6> :call List_on_off()
map <F5> :call Paste_on_off()
map <F4> :TlistToggle
...
silent only
cd ~/projects/post-a-job/postajob
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +38 position/models.py
badd +406 ~/projects/direct-seo/directseo/seo/models.py
badd +0 \'2
badd +0 ~/projects/post-a-job/postajob/position/tests.py
badd +0 ~/projects/post-a-job/postajob/position/views.py
badd +0 position/forms.py
silent! argdel *
edit position/models.py
